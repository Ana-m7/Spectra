        ...
        <div style={{ minHeight: '100vh', background: '#f9f8ff', fontFamily: 'Inter, sans-serif' }}>
            ...
            <nav style={{ padding: '1.25rem 4rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #f3f4f6', position: 'sticky', top: 0, background: 'rgba(255,255,255,0.97)', backdropFilter: 'blur(8px)', zIndex: 100 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <SpectraLogo size={38} />
                    <span style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '22px', fontWeight: '700', color: '#4c1d95', letterSpacing: '-0.02em' }}>Spectra</span>
                </div>
                <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                    <button className="nav-btn" onClick={() => navigate('/awareness')}
            ...
            <div style={{ background: 'linear-gradient(135deg, #f5f3ff 0%, #fdf4ff 50%, #ede9fe 100%)', padding: '6rem 4rem 5rem' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                    <div style={{ display: 'inline-block', background: 'white', color: '#7c3aed', border: '1px solid #ddd6fe', padding: '0.4rem 1.25rem', borderRadius: '999px', fontSize: '13px', fontWeight: '600', marginBottom: '2rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                        Early Autism Awareness for Parents
                    </div>
                    <h1 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: 'clamp(2.2rem, 5vw, 3.6rem)', fontWeight: '800', color: '#1e1b4b', lineHeight: '1.15', marginBottom: '1.5rem', letterSpacing: '-0.02em' }}>
                    ...
                    <p style={{ fontSize: '1.15rem', color: '#6b7280', lineHeight: '1.8', marginBottom: '2.5rem', maxWidth: '600px', margin: '0 auto 2.5rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <button className="cta-outline" onClick={() => navigate('/awareness')}
            ...
            <div style={{ position: 'relative', overflow: 'hidden', height: '480px' }}>
                ...
                <div style={{ position: 'absolute', left: '4rem', top: '50%', transform: 'translateY(-50%)', color: 'white', maxWidth: '460px' }}>
                    <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '2rem', fontWeight: '700', lineHeight: '1.3', marginBottom: '1rem' }}>
                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '2rem', textAlign: 'center' }}>
                    {stats.map((s, i) => (
                        <div key={i} style={{ padding: '1.5rem', background: 'rgba(255,255,255,0.1)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.2)' }}>
                            <p style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '2.5rem', fontWeight: '800', color: 'white', marginBottom: '0.5rem' }}>{s.number}</p>
                            <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)', lineHeight: '1.5' }}>{s.label}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div style={{ padding: '6rem 4rem', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                <div style={{ display: 'inline-block', background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca', padding: '0.4rem 1.25rem', borderRadius: '999px', fontSize: '13px', fontWeight: '600', marginBottom: '1.5rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                    The Problem
                </div>
                <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', fontWeight: '700', color: '#1e1b4b', marginBottom: '1.5rem', lineHeight: '1.2' }}>
                    Parents feel something is wrong. The system does not listen.
                </h2>
                <p style={{ fontSize: '1.05rem', color: '#6b7280', lineHeight: '1.9', marginBottom: '1.25rem' }}>
                ...
                <p style={{ fontSize: '1.05rem', color: '#6b7280', lineHeight: '1.9' }}>
            ...
            {/* Features */}
            <div style={{ background: '#f9f8ff', padding: '6rem 4rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
                    <div style={{ display: 'inline-block', background: '#f5f3ff', color: '#7c3aed', border: '1px solid #ddd6fe', padding: '0.4rem 1.25rem', borderRadius: '999px', fontSize: '13px', fontWeight: '600', marginBottom: '1rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                        Platform Features
                    </div>
                    <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: 'clamp(1.8rem, 3vw, 2.4rem)', fontWeight: '700', color: '#1e1b4b', marginBottom: '0.75rem' }}>
                    ...
                    {features.map((f, i) => (
                        <div key={i} className="feature-card" style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.06)', transition: 'transform 0.25s, box-shadow 0.25s', cursor: 'default' }}>
                            ...
                            <div style={{ padding: '2rem', borderTop: `4px solid ${f.border}` }}>
                                <h3 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '1.2rem', fontWeight: '700', color: '#1e1b4b', marginBottom: '0.75rem' }}>{f.title}</h3>
                                <p style={{ fontSize: '0.9rem', color: '#6b7280', lineHeight: '1.75' }}>{f.desc}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div style={{ background: 'linear-gradient(135deg, #1e1b4b, #4c1d95, #7c3aed)', padding: '6rem 4rem', textAlign: 'center' }}>
                <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: 'clamp(1.8rem, 3.5vw, 2.8rem)', fontWeight: '800', color: 'white', marginBottom: '1rem', letterSpacing: '-0.02em' }}>
                    Ready to understand your child better?
                </h2>
                <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.8)', marginBottom: '2.5rem', maxWidth: '480px', margin: '0 auto 2.5rem', lineHeight: '1.7' }}>
            ...
            <div style={{ background: '#1e1b4b', padding: '3rem 4rem' }}>
                <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <SpectraLogo size={34} />
                        <span style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '1.2rem', fontWeight: '700', color: 'white' }}>Spectra</span>
                    </div>
                    <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', maxWidth: '400px', textAlign: 'center', lineHeight: '1.6' }}>
